...
export default function Home() {
  ...
  return (
    <div style={{ maxWidth: '100%', background: "linear-gradient(135deg, #C3FCF5 0%, #8DFDF0 100%)", minHeight: "100%", padding: windowWidth > 470 ? "20px 20px" : "20px 40px", height : "auto" }}>
      <div style={{ fontFamily: 'Poppins, sans-serif', maxWidth: '1300px', margin: '0 auto', background: "#f8f9fa", padding: windowWidth > 470 ? "30px 30px" : "10px 30px",  borderRadius: "20px", boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)", height : "auto" }}>
        <Head>
